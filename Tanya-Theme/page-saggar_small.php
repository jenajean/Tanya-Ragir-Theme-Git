<?php
	/* Template Name: Saggar & Small Walls */
?>
...
<div class='main-content'>	
	...
	<div class='main-content-art-port'> 
				<?php $recent = new WP_Query("page_id=1556542511"); while($recent->have_posts())
				: $recent->the_post();?>
				       <!-- <h3><?php the_title(); ?></h3> -->
				       <?php the_content(); ?>
				<?php endwhile; ?>
		...
		<ul id='work-menu-show'>
			...
			<li>
				<ul id='subWork' class='dd'>
					...
					<li><a href='http://bugswag.com/saggar_small/' class="selected">saggar-fired & wall pieces</a></li>
