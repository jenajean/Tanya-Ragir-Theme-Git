<?php
	/* Template Name: Classical Figurative */
?>
		...
		<ul id='work-menu-show'>
			...
			<li>
				<ul id='subWork' class='dd'>
					...
					<li><a href='http://bugswag.com/classical_figurative/' class="selected">classical figurative</a></li>
			...
			<li class='mainList' target="_blank"><a href='http://www.tanyaragir.com/blog'>Studio Blog</a></li>
