...
<div id="tab_section_wrapper">
	<div id="tabs">
		<ul>
			...
			<li id="center2" class="selected-tab"><a href="http://bugswag.com/page-press-1990">1990-99</a></li>
	...
	<div id="tabbed_content">
		...
		<div id='center2' class="center-press viewed">
			<?php echo do_shortcode('[portfolio_slideshow id="1556542969" pagerstyle=carousel pagerpos=top  navpos=disabled showtitles=true ]');?>
		</div>
