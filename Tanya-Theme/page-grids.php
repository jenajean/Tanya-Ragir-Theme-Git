	...
	<nav id='grids'>
			<ul id='work-menu-show'>
				...
				<ul id='subWork' style="display:block;" class='dd'>
 				<li><a class='selected' href='http://bugswag.com/grids/'>grids and totems</a></li>
			...
			<br />
			<li class='mainList'><a href='http://tanyaragir.com/blog'>Studio Blog</a></li>
		</ul>
	</nav>
