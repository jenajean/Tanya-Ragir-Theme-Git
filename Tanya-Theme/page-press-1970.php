...
<div id="tab_section_wrapper">
	<div id="tabs">
		<ul>
			<li id="center1"><a href="http://bugswag.com/page-press-2000">Recent Press</a></li>
			<li id="center2"><a href="http://bugswag.com/page-press-1990">1990-99</a></li>
			<li id="center3" class="selected-tab"><a href="http://bugswag.com/page-press-1970">1976-89</a></li>
		</ul>
	</div><!--end tabs-->
	<div id="tabbed_content">

		
		<div id='center3' class="center-press viewed"> 
			<?php echo do_shortcode('[portfolio_slideshow id="1556544617" pagerstyle=carousel pagerpos=top  navpos=disabled showtitles=true ]');?>
